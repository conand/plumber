...
from trraces.replay_interfaces.angr.symbolic_input_replay_helper import SymbolicInputReplayHelper
...
class PlumberReplayHelper(SymbolicInputReplayHelper):
...
def setup_plumber_pointer_state(trace_dir, state, **kwargs):
    return setup_generic_state(trace_dir, state, AngrStateManipulationInterface, PlumberPointerReplayHelper)
